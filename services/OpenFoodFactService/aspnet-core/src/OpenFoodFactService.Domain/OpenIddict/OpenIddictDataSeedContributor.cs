...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("OpenFoodFactService") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "OpenFoodFactService", DisplayName = "OpenFoodFactService API", Resources = { "OpenFoodFactService" }
            });
        }
    }
