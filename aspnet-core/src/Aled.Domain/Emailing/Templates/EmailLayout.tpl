                        ...
                        <td class="column column-1" width="100%"
                          ...
                          <table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0"
                            ...
                            <tr>
                              <td class="pad">
                                <h2
                                  style="margin: 0; color: #000; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 20px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 36px;">
                                  <span class="tinyMce-placeholder" style="word-break: break-word;">Aled.</span>
                                </h2>
                              </td>
                            </tr>
                          </table>
                        ...
                        <td class="column column-1" width="100%"
                          ...
                          <table class="paragraph_block block-1" width="100%" border="0" cellpadding="10"
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#909497;direction:ltr;font-family: 'Inter', sans-serif;font-size:10px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0;">©&nbsp;2024 Aled</p>
                                </div>
                              </td>
                            </tr>
                          </table>
                                ...
                                <table class="icons-inner"
                                  ...
                                  <tr>
                                    <td
                                      ...
                                      <a href="http://designedwithbeefree.com/" target="_blank"
                                        style="text-decoration: none;"><img class="icon" alt="Beefree Logo"
                                          src="https://d1oco4z2z1fhwp.cloudfront.net/assets/Beefree-logo.png"
                                          height="auto" width="34" align="center"
                                    ...
                                    <td
                                      ...
                                      <a href="http://designedwithbeefree.com/" target="_blank"
                                        style="color: #1e0e4b; text-decoration: none;">Designed with Beefree</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
