...
public class OpenFoodFactServiceWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public OpenFoodFactServiceWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<OpenFoodFactServiceResource>();
